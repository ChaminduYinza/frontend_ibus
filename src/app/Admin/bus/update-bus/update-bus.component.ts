...
export class UpdateBusComponent implements OnInit {
  ...
  constructor(private routeService: RouteServiceService, private busService: BusService, private formBuilder: FormBuilder, private router: Router, private activatedRoute: ActivatedRoute) {
